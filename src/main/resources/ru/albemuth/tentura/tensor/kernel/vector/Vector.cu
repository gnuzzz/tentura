...
template<typename T>
__device__ void scalarSubVector(const T scalar, const T* A, T* C, const int length) {
...
template<typename T>
__device__ void scalarDivVector(const T scalar, const T* A, T* C, const int length) {
